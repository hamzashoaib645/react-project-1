      ...
      <Container maxWidth='x-lg'>
        ...
        <div className='staff-head'>
            ...
            <div className='children-icons'>
              <span className='span-radio'>
                <input type="radio"
                  name="fav_language"
                  className='icons'
                  style={{ backgroundColor: '#20F738', borderRadius: '50%' }}
                />
                1
              </span>
              <span className='span-radio'>
                <input type="radio" name="fav_language" className='icons' />0
              </span>
              <span className='span-radio'>
                <input type="radio" name="fav_language" className='icons' />0
              </span>
          ...
          <div className='children-btns'>
            ...
            <Button style={{ marginRight: '18px' }} variant='contained'>
